...
#define MOTOR_PWM_MAX 2
#define SENSOR_EDGES_TARGET 4  // Adjust this value as needed
...
void driveMotor() {
    ...
    while (sensorEdges < SENSOR_EDGES_TARGET) {
    	...
    	int16_t sensorEdgesDummy = sensorEdges;
        // Read sensor values
        readSensors();
        ...
        if (sensorEdgesDummy < sensorEdges)
        {
